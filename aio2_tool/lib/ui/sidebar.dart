...
class _ClassicSidebarState extends State<_ClassicSidebar> {
  ...
  bool _isPaleHaxExpanded = true; // PaleHax varsayılan açık olsun
                    ...
                    secondChild: Column(
                      children: [
                        ...
                        _item(15, Icons.groups, "Oyuncular", isDark,
                            isRgb: true),
                        _item(16, Icons.shield, "Takımlar", isDark),
                        _item(17, Icons.scoreboard, "Maçlar", isDark),
                        _item(18, Icons.format_list_numbered, "Puan", isDark),
                        _item(19, Icons.bar_chart, "İstatistik", isDark),
                        _item(20, Icons.compare_arrows, "Transfer", isDark),
                        _item(21, Icons.emoji_events, "Challenge", isDark,
                            isRgb: true),
                        _item(
                            22, Icons.workspace_premium, "Hall of Fame", isDark,
                            isRgb: true),
                      ],
                    ),
                          ...
                          child: Column(
                            children: [
                              ...
                              _modernItem(context, Icons.groups, "Oyuncular",
                                  15, isDark),
                              _modernItem(context, Icons.shield, "Takımlar", 16,
                                  isDark),
                              _modernItem(context, Icons.scoreboard, "Maçlar",
                                  17, isDark),
                              _modernItem(context, Icons.format_list_numbered,
                                  "Puan", 18, isDark),
                              _modernItem(context, Icons.bar_chart,
                                  "İstatistik", 19, isDark),
                              _modernItem(context, Icons.compare_arrows,
                                  "Transfer", 20, isDark),
                              _modernItem(context, Icons.emoji_events,
                                  "Challenge", 21, isDark),
                              _modernItem(context, Icons.workspace_premium,
                                  "Hall of Fame", 22, isDark),
                            ],
                          ),
                        ),
                        crossFadeState: _isPaleHaxExpanded
